...
def calc_window(pos, n, reg_n, search_window):
    """Find start/stop bounds within search_window size around a position"""
...
def compute_match(frameA, frameB,method="covariance",fsum=None):
    """Compute the quality of the match between two regions of pixels"""
...
def find_match(frame_1, frame_2, loc_1, reg_nx=20, reg_ny=20, search_window=5):
...
def main(filename="/Users/gutmann/Desktop/IMG_2303.m4v",
    ...
    """Example script to read in an track a point in the image over a video"""
